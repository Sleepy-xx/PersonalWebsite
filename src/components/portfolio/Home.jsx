  ...
  return (
    ...
    <div className="min-h-screen bg-[#121212] flex flex-col items-center isolate">
      ...
      <div className="w-full max-w-[1200px] mt-[60px] mb-[15px] ml-[414px] mr-[414px] flex flex-col lg:flex-row gap-6 px-4 lg:px-0">
        ...
        {/* 3. 左侧 Sidebar */}
        <aside className="w-full bg-[#1e1e1f] border border-[#2d2d2d] rounded-[20px] lg:w-[280px] shrink-0 lg:sticky lg:top-[60px] lg:self-start z-10 pt-[60px] pl-[30px] pr-[30px] pb-[30px]">
          <ProfileSidebar />
        </aside>
